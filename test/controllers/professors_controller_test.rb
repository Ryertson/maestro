...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { matricula: @professor.matricula, nome: @professor.nome } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { matricula: @professor.matricula, nome: @professor.nome } }
