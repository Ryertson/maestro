...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { course_id: @classroom.course_id, grade: @classroom.grade, section: @classroom.section } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { course_id: @classroom.course_id, grade: @classroom.grade, section: @classroom.section } }
